...
namespace HooksDefinitions
{
	...
	//RVA
	uintptr_t offsetNetworkPlayerStart = 0x12AE8F0; // -> <Player>.Start()
	uintptr_t offsetNetworkPlayerDestroy = 0x12A84C0; // -> <Player>.OnDestroy()
	uintptr_t offsetWorldToScreenPoint = 0x1E00620; // -> <Camera>.WorldToScreenPoint(Vector3)
	uintptr_t offsetScreenToWorldPoint = 0x1E00230; // -> <Camera>.ScreenToWorldPoint(Vector3)
	uintptr_t offsetLocalPlayerStart = 0x1141C60; // -> <LocalPlayer>.Start()
